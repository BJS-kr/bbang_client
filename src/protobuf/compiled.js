...
$root.CharacterPositionData = (function () {
  ...
  CharacterPositionData.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.x != null && Object.hasOwnProperty.call(message, 'x')) writer.uint32(/* id 1, wireType 5 =*/ 13).float(message.x);
    if (message.y != null && Object.hasOwnProperty.call(message, 'y')) writer.uint32(/* id 2, wireType 5 =*/ 21).float(message.y);
    return writer;
  };
