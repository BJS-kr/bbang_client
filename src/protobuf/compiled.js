...
$root.RoomData = (function () {
  ...
  RoomData.encode = function encode(message, writer) {
    ...
    if (message.ownerId != null && Object.hasOwnProperty.call(message, 'ownerId')) writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.ownerId);
    if (message.name != null && Object.hasOwnProperty.call(message, 'name')) writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.name);
    ...
    if (message.state != null && Object.hasOwnProperty.call(message, 'state')) writer.uint32(/* id 5, wireType 0 =*/ 40).int32(message.state);
  ...
  RoomData.verify = function verify(message) {
    ...
    if (message.ownerId != null && message.hasOwnProperty('ownerId')) if (!$util.isString(message.ownerId)) return 'ownerId: string expected';
    ...
    if (message.maxUserNum != null && message.hasOwnProperty('maxUserNum'))
      if (!$util.isInteger(message.maxUserNum)) return 'maxUserNum: integer expected';
  ...
  RoomData.fromObject = function fromObject(object) {
    if (object instanceof $root.RoomData) return object;
    var message = new $root.RoomData();
    if (object.id != null) message.id = object.id | 0;
    if (object.ownerId != null) message.ownerId = String(object.ownerId);
    if (object.name != null) message.name = String(object.name);
    if (object.maxUserNum != null) message.maxUserNum = object.maxUserNum | 0;
    if (object.state != null) message.state = object.state | 0;
    if (object.users) {
      if (!Array.isArray(object.users)) throw TypeError('.RoomData.users: array expected');
      message.users = [];
      for (var i = 0; i < object.users.length; ++i) {
        if (typeof object.users[i] !== 'object') throw TypeError('.RoomData.users: object expected');
  ...
  RoomData.toObject = function toObject(message, options) {
    ...
    if (message.ownerId != null && message.hasOwnProperty('ownerId')) object.ownerId = message.ownerId;
    if (message.name != null && message.hasOwnProperty('name')) object.name = message.name;
    if (message.maxUserNum != null && message.hasOwnProperty('maxUserNum')) object.maxUserNum = message.maxUserNum;
    if (message.state != null && message.hasOwnProperty('state')) object.state = message.state;
    if (message.users && message.users.length) {
      object.users = [];
      for (var j = 0; j < message.users.length; ++j) object.users[j] = $root.UserData.toObject(message.users[j], options);
    }
    return object;
  };
...
$root.UserData = (function () {
  ...
  UserData.fromObject = function fromObject(object) {
    if (object instanceof $root.UserData) return object;
    var message = new $root.UserData();
    if (object.id != null) message.id = String(object.id);
    if (object.nickname != null) message.nickname = String(object.nickname);
    if (object.character != null) {
      if (typeof object.character !== 'object') throw TypeError('.UserData.character: object expected');
  ...
  UserData.toObject = function toObject(message, options) {
    ...
    if (message.character != null && message.hasOwnProperty('character')) object.character = $root.CharacterData.toObject(message.character, options);
    return object;
  };
...
$root.CharacterData = (function () {
  ...
  CharacterData.encode = function encode(message, writer) {
    ...
    if (message.hp != null && Object.hasOwnProperty.call(message, 'hp')) writer.uint32(/* id 3, wireType 0 =*/ 24).int32(message.hp);
    if (message.weapon != null && Object.hasOwnProperty.call(message, 'weapon')) writer.uint32(/* id 4, wireType 0 =*/ 32).int32(message.weapon);
    ...
    if (message.equips != null && message.equips.length) {
      ...
      for (var i = 0; i < message.equips.length; ++i) writer.int32(message.equips[i]);
      writer.ldelim();
    }
    if (message.debuffs != null && message.debuffs.length) {
      writer.uint32(/* id 8, wireType 2 =*/ 66).fork();
      for (var i = 0; i < message.debuffs.length; ++i) writer.int32(message.debuffs[i]);
      writer.ldelim();
    }
  ...
  CharacterData.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.CharacterData();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 7: {
          if (!(message.equips && message.equips.length)) message.equips = [];
          if ((tag & 7) === 2) {
            var end2 = reader.uint32() + reader.pos;
            while (reader.pos < end2) message.equips.push(reader.int32());
          } else message.equips.push(reader.int32());
          break;
        }
        case 8: {
          if (!(message.debuffs && message.debuffs.length)) message.debuffs = [];
          if ((tag & 7) === 2) {
            var end2 = reader.uint32() + reader.pos;
            while (reader.pos < end2) message.debuffs.push(reader.int32());
          } else message.debuffs.push(reader.int32());
          break;
        }
        case 9: {
          if (!(message.handCards && message.handCards.length)) message.handCards = [];
  ...
  CharacterData.verify = function verify(message) {
    ...
    if (message.characterType != null && message.hasOwnProperty('characterType'))
      if (!$util.isInteger(message.characterType)) return 'characterType: integer expected';
    if (message.roleType != null && message.hasOwnProperty('roleType')) if (!$util.isInteger(message.roleType)) return 'roleType: integer expected';
    ...
    if (message.stateInfo != null && message.hasOwnProperty('stateInfo')) {
      ...
      if (error) return 'stateInfo.' + error;
    }
    ...
    if (message.equips != null && message.hasOwnProperty('equips')) {
      if (!Array.isArray(message.equips)) return 'equips: array expected';
      for (var i = 0; i < message.equips.length; ++i) if (!$util.isInteger(message.equips[i])) return 'equips: integer[] expected';
    }
    if (message.debuffs != null && message.hasOwnProperty('debuffs')) {
      if (!Array.isArray(message.debuffs)) return 'debuffs: array expected';
      for (var i = 0; i < message.debuffs.length; ++i) if (!$util.isInteger(message.debuffs[i])) return 'debuffs: integer[] expected';
    }
    if (message.handCards != null && message.hasOwnProperty('handCards')) {
      if (!Array.isArray(message.handCards)) return 'handCards: array expected';
      for (var i = 0; i < message.handCards.length; ++i) {
        var error = $root.CardData.verify(message.handCards[i]);
        if (error) return 'handCards.' + error;
      }
    }
    return null;
  };
  ...
  CharacterData.fromObject = function fromObject(object) {
    if (object instanceof $root.CharacterData) return object;
    var message = new $root.CharacterData();
    if (object.characterType != null) message.characterType = object.characterType | 0;
    if (object.roleType != null) message.roleType = object.roleType | 0;
    if (object.hp != null) message.hp = object.hp | 0;
    if (object.weapon != null) message.weapon = object.weapon | 0;
    if (object.stateInfo != null) {
      if (typeof object.stateInfo !== 'object') throw TypeError('.CharacterData.stateInfo: object expected');
      message.stateInfo = $root.CharacterStateInfoData.fromObject(object.stateInfo);
    }
    if (object.position != null) {
      if (typeof object.position !== 'object') throw TypeError('.CharacterData.position: object expected');
      message.position = $root.CharacterPositionData.fromObject(object.position);
    }
    if (object.equips) {
      if (!Array.isArray(object.equips)) throw TypeError('.CharacterData.equips: array expected');
      message.equips = [];
      for (var i = 0; i < object.equips.length; ++i) message.equips[i] = object.equips[i] | 0;
    }
    if (object.debuffs) {
      if (!Array.isArray(object.debuffs)) throw TypeError('.CharacterData.debuffs: array expected');
      message.debuffs = [];
      for (var i = 0; i < object.debuffs.length; ++i) message.debuffs[i] = object.debuffs[i] | 0;
    }
    if (object.handCards) {
      if (!Array.isArray(object.handCards)) throw TypeError('.CharacterData.handCards: array expected');
      message.handCards = [];
      for (var i = 0; i < object.handCards.length; ++i) {
        if (typeof object.handCards[i] !== 'object') throw TypeError('.CharacterData.handCards: object expected');
  ...
  CharacterData.toObject = function toObject(message, options) {
    ...
    if (message.characterType != null && message.hasOwnProperty('characterType')) object.characterType = message.characterType;
    if (message.roleType != null && message.hasOwnProperty('roleType')) object.roleType = message.roleType;
    ...
    if (message.equips && message.equips.length) {
      object.equips = [];
      for (var j = 0; j < message.equips.length; ++j) object.equips[j] = message.equips[j];
    }
    if (message.debuffs && message.debuffs.length) {
      object.debuffs = [];
      for (var j = 0; j < message.debuffs.length; ++j) object.debuffs[j] = message.debuffs[j];
    }
    if (message.handCards && message.handCards.length) {
      object.handCards = [];
      for (var j = 0; j < message.handCards.length; ++j) object.handCards[j] = $root.CardData.toObject(message.handCards[j], options);
    }
    return object;
  };
...
$root.CharacterPositionData = (function () {
  ...
  CharacterPositionData.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.x != null && Object.hasOwnProperty.call(message, 'x')) writer.uint32(/* id 2, wireType 5 =*/ 21).float(message.x);
    if (message.y != null && Object.hasOwnProperty.call(message, 'y')) writer.uint32(/* id 3, wireType 5 =*/ 29).float(message.y);
    return writer;
  };
  ...
  CharacterPositionData.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.CharacterPositionData();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 2: {
  ...
  CharacterPositionData.fromObject = function fromObject(object) {
    if (object instanceof $root.CharacterPositionData) return object;
...
$root.CardData = (function () {
  ...
  CardData.encode = function encode(message, writer) {
    ...
    if (message.count != null && Object.hasOwnProperty.call(message, 'count')) writer.uint32(/* id 2, wireType 0 =*/ 16).int32(message.count);
    return writer;
  };
  ...
  CardData.fromObject = function fromObject(object) {
    if (object instanceof $root.CardData) return object;
...
$root.GameStateData = (function () {
  ...
  GameStateData.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.GameStateData();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  GameStateData.verify = function verify(message) {
    ...
    if (message.phaseType != null && message.hasOwnProperty('phaseType'))
      if (!$util.isInteger(message.phaseType)) return 'phaseType: integer expected';
    if (message.nextPhaseAt != null && message.hasOwnProperty('nextPhaseAt'))
      if (
        !$util.isInteger(message.nextPhaseAt) &&
        !(message.nextPhaseAt && $util.isInteger(message.nextPhaseAt.low) && $util.isInteger(message.nextPhaseAt.high))
      )
  ...
  GameStateData.fromObject = function fromObject(object) {
    if (object instanceof $root.GameStateData) return object;
    var message = new $root.GameStateData();
    if (object.phaseType != null) message.phaseType = object.phaseType | 0;
    if (object.nextPhaseAt != null)
      if ($util.Long) (message.nextPhaseAt = $util.Long.fromValue(object.nextPhaseAt)).unsigned = false;
      else if (typeof object.nextPhaseAt === 'string') message.nextPhaseAt = parseInt(object.nextPhaseAt, 10);
      else if (typeof object.nextPhaseAt === 'number') message.nextPhaseAt = object.nextPhaseAt;
  ...
  GameStateData.toObject = function toObject(message, options) {
    ...
    if (options.defaults) {
      ...
      } else object.nextPhaseAt = options.longs === String ? '0' : 0;
    }
    if (message.phaseType != null && message.hasOwnProperty('phaseType')) object.phaseType = message.phaseType;
    if (message.nextPhaseAt != null && message.hasOwnProperty('nextPhaseAt'))
      if (typeof message.nextPhaseAt === 'number') object.nextPhaseAt = options.longs === String ? String(message.nextPhaseAt) : message.nextPhaseAt;
      else
        object.nextPhaseAt =
          options.longs === String
            ? $util.Long.prototype.toString.call(message.nextPhaseAt)
            : options.longs === Number
              ? new $util.LongBits(message.nextPhaseAt.low >>> 0, message.nextPhaseAt.high >>> 0).toNumber()
              : message.nextPhaseAt;
    return object;
  };
...
$root.CharacterStateInfoData = (function () {
  ...
  CharacterStateInfoData.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.CharacterStateInfoData();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  CharacterStateInfoData.verify = function verify(message) {
    ...
    if (message.nextState != null && message.hasOwnProperty('nextState'))
      if (!$util.isInteger(message.nextState)) return 'nextState: integer expected';
    if (message.nextStateAt != null && message.hasOwnProperty('nextStateAt'))
      if (
        !$util.isInteger(message.nextStateAt) &&
        !(message.nextStateAt && $util.isInteger(message.nextStateAt.low) && $util.isInteger(message.nextStateAt.high))
      )
  ...
  CharacterStateInfoData.fromObject = function fromObject(object) {
    if (object instanceof $root.CharacterStateInfoData) return object;
    var message = new $root.CharacterStateInfoData();
    if (object.state != null) message.state = object.state | 0;
    if (object.nextState != null) message.nextState = object.nextState | 0;
    if (object.nextStateAt != null)
      if ($util.Long) (message.nextStateAt = $util.Long.fromValue(object.nextStateAt)).unsigned = false;
      else if (typeof object.nextStateAt === 'string') message.nextStateAt = parseInt(object.nextStateAt, 10);
      else if (typeof object.nextStateAt === 'number') message.nextStateAt = object.nextStateAt;
  ...
  CharacterStateInfoData.toObject = function toObject(message, options) {
    ...
    if (options.defaults) {
      ...
      } else object.nextStateAt = options.longs === String ? '0' : 0;
    }
    if (message.state != null && message.hasOwnProperty('state')) object.state = message.state;
    if (message.nextState != null && message.hasOwnProperty('nextState')) object.nextState = message.nextState;
    if (message.nextStateAt != null && message.hasOwnProperty('nextStateAt'))
      if (typeof message.nextStateAt === 'number') object.nextStateAt = options.longs === String ? String(message.nextStateAt) : message.nextStateAt;
      else
        object.nextStateAt =
          options.longs === String
            ? $util.Long.prototype.toString.call(message.nextStateAt)
            : options.longs === Number
              ? new $util.LongBits(message.nextStateAt.low >>> 0, message.nextStateAt.high >>> 0).toNumber()
              : message.nextStateAt;
    return object;
  };
...
$root.C2SRegisterRequest = (function () {
  ...
  C2SRegisterRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SRegisterRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  C2SRegisterRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SRegisterRequest) return object;
...
$root.S2CRegisterResponse = (function () {
  ...
  S2CRegisterResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CRegisterResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CRegisterResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CRegisterResponse) return object;
    ...
    if (message.failCode != null && message.hasOwnProperty('failCode'))
      object.failCode =
        options.enums === String
          ? $root.GlobalFailCode[message.failCode] === undefined
            ? message.failCode
            : $root.GlobalFailCode[message.failCode]
          : message.failCode;
    return object;
  };
...
$root.C2SLoginRequest = (function () {
  ...
  C2SLoginRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SLoginRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  C2SLoginRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SLoginRequest) return object;
...
$root.S2CLoginResponse = (function () {
  ...
  S2CLoginResponse.encode = function encode(message, writer) {
    ...
    if (message.success != null && Object.hasOwnProperty.call(message, 'success')) writer.uint32(/* id 1, wireType 0 =*/ 8).bool(message.success);
    if (message.message != null && Object.hasOwnProperty.call(message, 'message')) writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.message);
    if (message.token != null && Object.hasOwnProperty.call(message, 'token')) writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.token);
  ...
  S2CLoginResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CLoginResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CLoginResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CLoginResponse) return object;
    var message = new $root.S2CLoginResponse();
    if (object.success != null) message.success = Boolean(object.success);
    if (object.message != null) message.message = String(object.message);
    if (object.token != null) message.token = String(object.token);
    if (object.myInfo != null) {
      if (typeof object.myInfo !== 'object') throw TypeError('.S2CLoginResponse.myInfo: object expected');
  ...
  S2CLoginResponse.toObject = function toObject(message, options) {
    ...
    if (message.myInfo != null && message.hasOwnProperty('myInfo')) object.myInfo = $root.UserData.toObject(message.myInfo, options);
    if (message.failCode != null && message.hasOwnProperty('failCode'))
      object.failCode =
        options.enums === String
          ? $root.GlobalFailCode[message.failCode] === undefined
...
$root.C2SCreateRoomRequest = (function () {
  ...
  C2SCreateRoomRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SCreateRoomRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  C2SCreateRoomRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SCreateRoomRequest) return object;
...
$root.S2CCreateRoomResponse = (function () {
  ...
  S2CCreateRoomResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CCreateRoomResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CCreateRoomResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CCreateRoomResponse) return object;
    var message = new $root.S2CCreateRoomResponse();
    if (object.success != null) message.success = Boolean(object.success);
    if (object.room != null) {
      if (typeof object.room !== 'object') throw TypeError('.S2CCreateRoomResponse.room: object expected');
  ...
  S2CCreateRoomResponse.toObject = function toObject(message, options) {
    ...
    if (message.success != null && message.hasOwnProperty('success')) object.success = message.success;
    if (message.room != null && message.hasOwnProperty('room')) object.room = $root.RoomData.toObject(message.room, options);
    if (message.failCode != null && message.hasOwnProperty('failCode'))
      object.failCode =
        options.enums === String
          ? $root.GlobalFailCode[message.failCode] === undefined
...
$root.C2SGetRoomListRequest = (function () {
  ...
  C2SGetRoomListRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SGetRoomListRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  C2SGetRoomListRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SGetRoomListRequest) return object;
...
$root.S2CGetRoomListResponse = (function () {
  ...
  S2CGetRoomListResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CGetRoomListResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CGetRoomListResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CGetRoomListResponse) return object;
    var message = new $root.S2CGetRoomListResponse();
    if (object.rooms) {
      if (!Array.isArray(object.rooms)) throw TypeError('.S2CGetRoomListResponse.rooms: array expected');
      message.rooms = [];
      for (var i = 0; i < object.rooms.length; ++i) {
        if (typeof object.rooms[i] !== 'object') throw TypeError('.S2CGetRoomListResponse.rooms: object expected');
  ...
  S2CGetRoomListResponse.toObject = function toObject(message, options) {
    ...
    if (message.rooms && message.rooms.length) {
      object.rooms = [];
      for (var j = 0; j < message.rooms.length; ++j) object.rooms[j] = $root.RoomData.toObject(message.rooms[j], options);
    }
    return object;
  };
...
$root.C2SJoinRoomRequest = (function () {
  ...
  C2SJoinRoomRequest.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.roomId != null && Object.hasOwnProperty.call(message, 'roomId')) writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.roomId);
    return writer;
  };
  ...
  C2SJoinRoomRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SJoinRoomRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  C2SJoinRoomRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SJoinRoomRequest) return object;
  ...
  C2SJoinRoomRequest.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.defaults) object.roomId = 0;
...
$root.S2CJoinRoomResponse = (function () {
  ...
  S2CJoinRoomResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CJoinRoomResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CJoinRoomResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CJoinRoomResponse) return object;
    var message = new $root.S2CJoinRoomResponse();
    if (object.success != null) message.success = Boolean(object.success);
    if (object.room != null) {
      if (typeof object.room !== 'object') throw TypeError('.S2CJoinRoomResponse.room: object expected');
      message.room = $root.RoomData.fromObject(object.room);
    }
    switch (object.failCode) {
      default:
...
$root.C2SJoinRandomRoomRequest = (function () {
  ...
  C2SJoinRandomRoomRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SJoinRandomRoomRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  C2SJoinRandomRoomRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SJoinRandomRoomRequest) return object;
...
$root.S2CJoinRandomRoomResponse = (function () {
  ...
  S2CJoinRandomRoomResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CJoinRandomRoomResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CJoinRandomRoomResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CJoinRandomRoomResponse) return object;
    var message = new $root.S2CJoinRandomRoomResponse();
    if (object.success != null) message.success = Boolean(object.success);
    if (object.room != null) {
      if (typeof object.room !== 'object') throw TypeError('.S2CJoinRandomRoomResponse.room: object expected');
      message.room = $root.RoomData.fromObject(object.room);
    }
    switch (object.failCode) {
      default:
...
$root.S2CJoinRoomNotification = (function () {
  ...
  S2CJoinRoomNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CJoinRoomNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CJoinRoomNotification.verify = function verify(message) {
    ...
    if (message.joinUser != null && message.hasOwnProperty('joinUser')) {
      ...
      if (error) return 'joinUser.' + error;
    }
    return null;
  };
  ...
  S2CJoinRoomNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CJoinRoomNotification) return object;
    var message = new $root.S2CJoinRoomNotification();
    if (object.joinUser != null) {
      if (typeof object.joinUser !== 'object') throw TypeError('.S2CJoinRoomNotification.joinUser: object expected');
  ...
  S2CJoinRoomNotification.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.defaults) object.joinUser = null;
    if (message.joinUser != null && message.hasOwnProperty('joinUser')) object.joinUser = $root.UserData.toObject(message.joinUser, options);
    return object;
  };
...
$root.C2SLeaveRoomRequest = (function () {
  ...
  C2SLeaveRoomRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SLeaveRoomRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  C2SLeaveRoomRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SLeaveRoomRequest) return object;
...
$root.S2CLeaveRoomResponse = (function () {
  ...
  S2CLeaveRoomResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CLeaveRoomResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CLeaveRoomResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CLeaveRoomResponse) return object;
...
$root.S2CLeaveRoomNotification = (function () {
  ...
  S2CLeaveRoomNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CLeaveRoomNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CLeaveRoomNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CLeaveRoomNotification) return object;
...
$root.C2SGamePrepareRequest = (function () {
  ...
  C2SGamePrepareRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SGamePrepareRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  C2SGamePrepareRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SGamePrepareRequest) return object;
...
$root.S2CGamePrepareResponse = (function () {
  ...
  S2CGamePrepareResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CGamePrepareResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CGamePrepareResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CGamePrepareResponse) return object;
...
$root.S2CGamePrepareNotification = (function () {
  ...
  S2CGamePrepareNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CGamePrepareNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CGamePrepareNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CGamePrepareNotification) return object;
    var message = new $root.S2CGamePrepareNotification();
    if (object.room != null) {
      if (typeof object.room !== 'object') throw TypeError('.S2CGamePrepareNotification.room: object expected');
      message.room = $root.RoomData.fromObject(object.room);
    }
    return message;
  };
  ...
  S2CGamePrepareNotification.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.defaults) object.room = null;
    if (message.room != null && message.hasOwnProperty('room')) object.room = $root.RoomData.toObject(message.room, options);
    return object;
  };
...
$root.C2SGameStartRequest = (function () {
  ...
  C2SGameStartRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SGameStartRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  C2SGameStartRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SGameStartRequest) return object;
...
$root.S2CGameStartResponse = (function () {
  ...
  S2CGameStartResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CGameStartResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CGameStartResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CGameStartResponse) return object;
...
$root.S2CGameStartNotification = (function () {
  ...
  S2CGameStartNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CGameStartNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CGameStartNotification.verify = function verify(message) {
    ...
    if (message.gameState != null && message.hasOwnProperty('gameState')) {
      ...
      if (error) return 'gameState.' + error;
    }
    if (message.users != null && message.hasOwnProperty('users')) {
      if (!Array.isArray(message.users)) return 'users: array expected';
      for (var i = 0; i < message.users.length; ++i) {
  ...
  S2CGameStartNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CGameStartNotification) return object;
    var message = new $root.S2CGameStartNotification();
    if (object.gameState != null) {
      if (typeof object.gameState !== 'object') throw TypeError('.S2CGameStartNotification.gameState: object expected');
      message.gameState = $root.GameStateData.fromObject(object.gameState);
    }
    if (object.users) {
      if (!Array.isArray(object.users)) throw TypeError('.S2CGameStartNotification.users: array expected');
      message.users = [];
      for (var i = 0; i < object.users.length; ++i) {
        if (typeof object.users[i] !== 'object') throw TypeError('.S2CGameStartNotification.users: object expected');
        message.users[i] = $root.UserData.fromObject(object.users[i]);
      }
    }
    return message;
  ...
  S2CGameStartNotification.toObject = function toObject(message, options) {
    ...
    var object = {};
    if (options.arrays || options.defaults) object.users = [];
    if (options.defaults) object.gameState = null;
    if (message.gameState != null && message.hasOwnProperty('gameState')) object.gameState = $root.GameStateData.toObject(message.gameState, options);
    if (message.users && message.users.length) {
      object.users = [];
      for (var j = 0; j < message.users.length; ++j) object.users[j] = $root.UserData.toObject(message.users[j], options);
    }
...
$root.C2SPositionUpdateRequest = (function () {
  ...
  C2SPositionUpdateRequest.encode = function encode(message, writer) {
    ...
    if (message.y != null && Object.hasOwnProperty.call(message, 'y')) writer.uint32(/* id 2, wireType 0 =*/ 16).int32(message.y);
    return writer;
  };
  ...
  C2SPositionUpdateRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SPositionUpdateRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  C2SPositionUpdateRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SPositionUpdateRequest) return object;
...
$root.S2CPositionUpdateResponse = (function () {
  ...
  S2CPositionUpdateResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CPositionUpdateResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CPositionUpdateResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CPositionUpdateResponse) return object;
...
$root.S2CPositionUpdateNotification = (function () {
  ...
  S2CPositionUpdateNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CPositionUpdateNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CPositionUpdateNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CPositionUpdateNotification) return object;
    var message = new $root.S2CPositionUpdateNotification();
    if (object.userId != null) message.userId = String(object.userId);
    if (object.position != null) {
      if (typeof object.position !== 'object') throw TypeError('.S2CPositionUpdateNotification.position: object expected');
      message.position = $root.CharacterPositionData.fromObject(object.position);
    }
    return message;
  };
...
$root.C2SUseCardRequest = (function () {
  ...
  C2SUseCardRequest.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.cardType != null && Object.hasOwnProperty.call(message, 'cardType')) writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.cardType);
  ...
  C2SUseCardRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SUseCardRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  C2SUseCardRequest.verify = function verify(message) {
    ...
    if (message.targetUserId != null && message.hasOwnProperty('targetUserId'))
      if (!$util.isString(message.targetUserId)) return 'targetUserId: string expected';
    return null;
  };
  ...
  C2SUseCardRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SUseCardRequest) return object;
    var message = new $root.C2SUseCardRequest();
    if (object.cardType != null) message.cardType = object.cardType | 0;
    if (object.targetUserId != null) message.targetUserId = String(object.targetUserId);
    return message;
  };
...
$root.S2CUseCardResponse = (function () {
  ...
  S2CUseCardResponse.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CUseCardResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CUseCardResponse.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CUseCardResponse) return object;
...
$root.S2CUseCardNotification = (function () {
  ...
  S2CUseCardNotification.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.cardType != null && Object.hasOwnProperty.call(message, 'cardType')) writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.cardType);
    if (message.userId != null && Object.hasOwnProperty.call(message, 'userId')) writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.userId);
    if (message.targetUserId != null && Object.hasOwnProperty.call(message, 'targetUserId'))
  ...
  S2CUseCardNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CUseCardNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CUseCardNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CUseCardNotification) return object;
...
$root.S2CEquipCardNotification = (function () {
  ...
  S2CEquipCardNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CEquipCardNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CEquipCardNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CEquipCardNotification) return object;
...
$root.S2CCardEffectNotification = (function () {
  ...
  S2CCardEffectNotification.encode = function encode(message, writer) {
    ...
    if (message.cardType != null && Object.hasOwnProperty.call(message, 'cardType')) writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.cardType);
    if (message.userId != null && Object.hasOwnProperty.call(message, 'userId')) writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.userId);
    if (message.success != null && Object.hasOwnProperty.call(message, 'success')) writer.uint32(/* id 3, wireType 0 =*/ 24).bool(message.success);
    return writer;
  };
  ...
  S2CCardEffectNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CCardEffectNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CCardEffectNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CCardEffectNotification) return object;
...
$root.S2CUserUpdateNotification = (function () {
  ...
  S2CUserUpdateNotification.encode = function encode(message, writer) {
    ...
    if (message.user != null && message.user.length)
      for (var i = 0; i < message.user.length; ++i) $root.UserData.encode(message.user[i], writer.uint32(/* id 1, wireType 2 =*/ 10).fork()).ldelim();
    return writer;
  };
  ...
  S2CUserUpdateNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CUserUpdateNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CUserUpdateNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CUserUpdateNotification) return object;
    var message = new $root.S2CUserUpdateNotification();
    if (object.user) {
      if (!Array.isArray(object.user)) throw TypeError('.S2CUserUpdateNotification.user: array expected');
      message.user = [];
      for (var i = 0; i < object.user.length; ++i) {
        if (typeof object.user[i] !== 'object') throw TypeError('.S2CUserUpdateNotification.user: object expected');
  ...
  S2CUserUpdateNotification.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.arrays || options.defaults) object.user = [];
    if (message.user && message.user.length) {
      object.user = [];
      for (var j = 0; j < message.user.length; ++j) object.user[j] = $root.UserData.toObject(message.user[j], options);
    }
    return object;
  };
...
$root.S2CPhaseUpdateNotification = (function () {
  ...
  S2CPhaseUpdateNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CPhaseUpdateNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CPhaseUpdateNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CPhaseUpdateNotification) return object;
...
$root.C2SDestroyCardRequest = (function () {
  ...
  C2SDestroyCardRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.C2SDestroyCardRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          if (!(message.destroyCards && message.destroyCards.length)) message.destroyCards = [];
  ...
  C2SDestroyCardRequest.verify = function verify(message) {
    ...
    if (message.destroyCards != null && message.hasOwnProperty('destroyCards')) {
      if (!Array.isArray(message.destroyCards)) return 'destroyCards: array expected';
      for (var i = 0; i < message.destroyCards.length; ++i) {
        var error = $root.CardData.verify(message.destroyCards[i]);
        if (error) return 'destroyCards.' + error;
      }
    }
    return null;
  };
  ...
  C2SDestroyCardRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.C2SDestroyCardRequest) return object;
    var message = new $root.C2SDestroyCardRequest();
    if (object.destroyCards) {
      if (!Array.isArray(object.destroyCards)) throw TypeError('.C2SDestroyCardRequest.destroyCards: array expected');
      message.destroyCards = [];
      for (var i = 0; i < object.destroyCards.length; ++i) {
        if (typeof object.destroyCards[i] !== 'object') throw TypeError('.C2SDestroyCardRequest.destroyCards: object expected');
  ...
  C2SDestroyCardRequest.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.arrays || options.defaults) object.destroyCards = [];
    if (message.destroyCards && message.destroyCards.length) {
      object.destroyCards = [];
      for (var j = 0; j < message.destroyCards.length; ++j) object.destroyCards[j] = $root.CardData.toObject(message.destroyCards[j], options);
    }
    return object;
  };
...
$root.S2CDestroyCardNotification = (function () {
  ...
  S2CDestroyCardNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CDestroyCardNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  S2CDestroyCardNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CDestroyCardNotification) return object;
    var message = new $root.S2CDestroyCardNotification();
    if (object.handCards) {
      if (!Array.isArray(object.handCards)) throw TypeError('.S2CDestroyCardNotification.handCards: array expected');
      message.handCards = [];
      for (var i = 0; i < object.handCards.length; ++i) {
        if (typeof object.handCards[i] !== 'object') throw TypeError('.S2CDestroyCardNotification.handCards: object expected');
        message.handCards[i] = $root.CardData.fromObject(object.handCards[i]);
      }
    }
    return message;
  ...
  S2CDestroyCardNotification.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.arrays || options.defaults) object.handCards = [];
    if (message.handCards && message.handCards.length) {
      object.handCards = [];
      for (var j = 0; j < message.handCards.length; ++j) object.handCards[j] = $root.CardData.toObject(message.handCards[j], options);
    }
...
$root.S2CGameEndNotification = (function () {
  ...
  S2CGameEndNotification.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.S2CGameEndNotification();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  S2CGameEndNotification.fromObject = function fromObject(object) {
    if (object instanceof $root.S2CGameEndNotification) return object;
...
$root.GamePacket = (function () {
  ...
  GamePacket.verify = function verify(message) {
    ...
    if (message.registerRequest != null && message.hasOwnProperty('registerRequest')) {
      properties.payload = 1;
      {
        ...
        if (error) return 'registerRequest.' + error;
      }
    }
    if (message.registerResponse != null && message.hasOwnProperty('registerResponse')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'registerResponse.' + error;
      }
    }
    ...
    if (message.loginResponse != null && message.hasOwnProperty('loginResponse')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'loginResponse.' + error;
      }
    }
    if (message.createRoomRequest != null && message.hasOwnProperty('createRoomRequest')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'createRoomRequest.' + error;
      }
    }
    if (message.createRoomResponse != null && message.hasOwnProperty('createRoomResponse')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'createRoomResponse.' + error;
      }
    }
    if (message.getRoomListRequest != null && message.hasOwnProperty('getRoomListRequest')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'getRoomListRequest.' + error;
      }
    }
    if (message.getRoomListResponse != null && message.hasOwnProperty('getRoomListResponse')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'getRoomListResponse.' + error;
      }
    }
    if (message.joinRoomRequest != null && message.hasOwnProperty('joinRoomRequest')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'joinRoomRequest.' + error;
      }
    }
    if (message.joinRoomResponse != null && message.hasOwnProperty('joinRoomResponse')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'joinRoomResponse.' + error;
      }
    }
    if (message.joinRandomRoomRequest != null && message.hasOwnProperty('joinRandomRoomRequest')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'joinRandomRoomRequest.' + error;
      }
    }
    if (message.joinRandomRoomResponse != null && message.hasOwnProperty('joinRandomRoomResponse')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'joinRandomRoomResponse.' + error;
      }
    }
    if (message.joinRoomNotification != null && message.hasOwnProperty('joinRoomNotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'joinRoomNotification.' + error;
      }
    }
    if (message.leaveRoomRequest != null && message.hasOwnProperty('leaveRoomRequest')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'leaveRoomRequest.' + error;
      }
    }
    if (message.leaveRoomResponse != null && message.hasOwnProperty('leaveRoomResponse')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'leaveRoomResponse.' + error;
      }
    }
    if (message.leaveRoomNotification != null && message.hasOwnProperty('leaveRoomNotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'leaveRoomNotification.' + error;
      }
    }
    if (message.gamePrepareRequest != null && message.hasOwnProperty('gamePrepareRequest')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'gamePrepareRequest.' + error;
      }
    }
    if (message.gamePrepareResponse != null && message.hasOwnProperty('gamePrepareResponse')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'gamePrepareResponse.' + error;
      }
    }
    if (message.gamePrepareNotification != null && message.hasOwnProperty('gamePrepareNotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'gamePrepareNotification.' + error;
      }
    }
    if (message.gameStartRequest != null && message.hasOwnProperty('gameStartRequest')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'gameStartRequest.' + error;
      }
    }
    if (message.gameStartResponse != null && message.hasOwnProperty('gameStartResponse')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'gameStartResponse.' + error;
      }
    }
    if (message.gameStartnotification != null && message.hasOwnProperty('gameStartnotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'gameStartnotification.' + error;
      }
    }
    if (message.positionUpdateRequest != null && message.hasOwnProperty('positionUpdateRequest')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'positionUpdateRequest.' + error;
      }
    }
    if (message.positionUpdateResponse != null && message.hasOwnProperty('positionUpdateResponse')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'positionUpdateResponse.' + error;
      }
    }
    if (message.positionUpdateNotification != null && message.hasOwnProperty('positionUpdateNotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'positionUpdateNotification.' + error;
      }
    }
    if (message.useCardRequest != null && message.hasOwnProperty('useCardRequest')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'useCardRequest.' + error;
      }
    }
    if (message.useCardResponse != null && message.hasOwnProperty('useCardResponse')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'useCardResponse.' + error;
      }
    }
    if (message.useCardNotification != null && message.hasOwnProperty('useCardNotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'useCardNotification.' + error;
      }
    }
    if (message.equipCardNotification != null && message.hasOwnProperty('equipCardNotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'equipCardNotification.' + error;
      }
    }
    if (message.cardEffectNotification != null && message.hasOwnProperty('cardEffectNotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'cardEffectNotification.' + error;
      }
    }
    if (message.userUpdateNotification != null && message.hasOwnProperty('userUpdateNotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'userUpdateNotification.' + error;
      }
    }
    if (message.phaseUpdateNotification != null && message.hasOwnProperty('phaseUpdateNotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'phaseUpdateNotification.' + error;
      }
    }
    if (message.destroyCardRequest != null && message.hasOwnProperty('destroyCardRequest')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'destroyCardRequest.' + error;
      }
    }
    if (message.destroyCardNotification != null && message.hasOwnProperty('destroyCardNotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'destroyCardNotification.' + error;
      }
    }
    if (message.gameEndNotification != null && message.hasOwnProperty('gameEndNotification')) {
      ...
      properties.payload = 1;
      {
        ...
        if (error) return 'gameEndNotification.' + error;
      }
    }
    return null;
  };
  ...
  GamePacket.fromObject = function fromObject(object) {
    if (object instanceof $root.GamePacket) return object;
    var message = new $root.GamePacket();
    if (object.registerRequest != null) {
      if (typeof object.registerRequest !== 'object') throw TypeError('.GamePacket.registerRequest: object expected');
      message.registerRequest = $root.C2SRegisterRequest.fromObject(object.registerRequest);
    }
    if (object.registerResponse != null) {
      if (typeof object.registerResponse !== 'object') throw TypeError('.GamePacket.registerResponse: object expected');
      message.registerResponse = $root.S2CRegisterResponse.fromObject(object.registerResponse);
    }
    if (object.loginRequest != null) {
      if (typeof object.loginRequest !== 'object') throw TypeError('.GamePacket.loginRequest: object expected');
      message.loginRequest = $root.C2SLoginRequest.fromObject(object.loginRequest);
    }
    if (object.loginResponse != null) {
      if (typeof object.loginResponse !== 'object') throw TypeError('.GamePacket.loginResponse: object expected');
      message.loginResponse = $root.S2CLoginResponse.fromObject(object.loginResponse);
    }
    if (object.createRoomRequest != null) {
      if (typeof object.createRoomRequest !== 'object') throw TypeError('.GamePacket.createRoomRequest: object expected');
      message.createRoomRequest = $root.C2SCreateRoomRequest.fromObject(object.createRoomRequest);
    }
    if (object.createRoomResponse != null) {
      if (typeof object.createRoomResponse !== 'object') throw TypeError('.GamePacket.createRoomResponse: object expected');
    ...
    if (object.getRoomListRequest != null) {
      if (typeof object.getRoomListRequest !== 'object') throw TypeError('.GamePacket.getRoomListRequest: object expected');
    ...
    if (object.getRoomListResponse != null) {
      if (typeof object.getRoomListResponse !== 'object') throw TypeError('.GamePacket.getRoomListResponse: object expected');
    ...
    if (object.joinRoomRequest != null) {
      if (typeof object.joinRoomRequest !== 'object') throw TypeError('.GamePacket.joinRoomRequest: object expected');
      message.joinRoomRequest = $root.C2SJoinRoomRequest.fromObject(object.joinRoomRequest);
    }
    if (object.joinRoomResponse != null) {
      if (typeof object.joinRoomResponse !== 'object') throw TypeError('.GamePacket.joinRoomResponse: object expected');
      message.joinRoomResponse = $root.S2CJoinRoomResponse.fromObject(object.joinRoomResponse);
    }
    if (object.joinRandomRoomRequest != null) {
      if (typeof object.joinRandomRoomRequest !== 'object') throw TypeError('.GamePacket.joinRandomRoomRequest: object expected');
    ...
    if (object.joinRandomRoomResponse != null) {
      if (typeof object.joinRandomRoomResponse !== 'object') throw TypeError('.GamePacket.joinRandomRoomResponse: object expected');
    ...
    if (object.joinRoomNotification != null) {
      if (typeof object.joinRoomNotification !== 'object') throw TypeError('.GamePacket.joinRoomNotification: object expected');
    ...
    if (object.leaveRoomRequest != null) {
      if (typeof object.leaveRoomRequest !== 'object') throw TypeError('.GamePacket.leaveRoomRequest: object expected');
      message.leaveRoomRequest = $root.C2SLeaveRoomRequest.fromObject(object.leaveRoomRequest);
    }
    if (object.leaveRoomResponse != null) {
      if (typeof object.leaveRoomResponse !== 'object') throw TypeError('.GamePacket.leaveRoomResponse: object expected');
    ...
    if (object.leaveRoomNotification != null) {
      if (typeof object.leaveRoomNotification !== 'object') throw TypeError('.GamePacket.leaveRoomNotification: object expected');
    ...
    if (object.gamePrepareRequest != null) {
      if (typeof object.gamePrepareRequest !== 'object') throw TypeError('.GamePacket.gamePrepareRequest: object expected');
    ...
    if (object.gamePrepareResponse != null) {
      if (typeof object.gamePrepareResponse !== 'object') throw TypeError('.GamePacket.gamePrepareResponse: object expected');
    ...
    if (object.gamePrepareNotification != null) {
      if (typeof object.gamePrepareNotification !== 'object') throw TypeError('.GamePacket.gamePrepareNotification: object expected');
    ...
    if (object.gameStartRequest != null) {
      if (typeof object.gameStartRequest !== 'object') throw TypeError('.GamePacket.gameStartRequest: object expected');
      message.gameStartRequest = $root.C2SGameStartRequest.fromObject(object.gameStartRequest);
    }
    if (object.gameStartResponse != null) {
      if (typeof object.gameStartResponse !== 'object') throw TypeError('.GamePacket.gameStartResponse: object expected');
    ...
    if (object.gameStartnotification != null) {
      if (typeof object.gameStartnotification !== 'object') throw TypeError('.GamePacket.gameStartnotification: object expected');
    ...
    if (object.positionUpdateRequest != null) {
      if (typeof object.positionUpdateRequest !== 'object') throw TypeError('.GamePacket.positionUpdateRequest: object expected');
    ...
    if (object.positionUpdateResponse != null) {
      if (typeof object.positionUpdateResponse !== 'object') throw TypeError('.GamePacket.positionUpdateResponse: object expected');
    ...
    if (object.positionUpdateNotification != null) {
      if (typeof object.positionUpdateNotification !== 'object') throw TypeError('.GamePacket.positionUpdateNotification: object expected');
    ...
    if (object.useCardRequest != null) {
      if (typeof object.useCardRequest !== 'object') throw TypeError('.GamePacket.useCardRequest: object expected');
      message.useCardRequest = $root.C2SUseCardRequest.fromObject(object.useCardRequest);
    }
    if (object.useCardResponse != null) {
      if (typeof object.useCardResponse !== 'object') throw TypeError('.GamePacket.useCardResponse: object expected');
      message.useCardResponse = $root.S2CUseCardResponse.fromObject(object.useCardResponse);
    }
    if (object.useCardNotification != null) {
      if (typeof object.useCardNotification !== 'object') throw TypeError('.GamePacket.useCardNotification: object expected');
    ...
    if (object.equipCardNotification != null) {
      if (typeof object.equipCardNotification !== 'object') throw TypeError('.GamePacket.equipCardNotification: object expected');
    ...
    if (object.cardEffectNotification != null) {
      if (typeof object.cardEffectNotification !== 'object') throw TypeError('.GamePacket.cardEffectNotification: object expected');
    ...
    if (object.userUpdateNotification != null) {
      if (typeof object.userUpdateNotification !== 'object') throw TypeError('.GamePacket.userUpdateNotification: object expected');
    ...
    if (object.phaseUpdateNotification != null) {
      if (typeof object.phaseUpdateNotification !== 'object') throw TypeError('.GamePacket.phaseUpdateNotification: object expected');
    ...
    if (object.destroyCardRequest != null) {
      if (typeof object.destroyCardRequest !== 'object') throw TypeError('.GamePacket.destroyCardRequest: object expected');
    ...
    if (object.destroyCardNotification != null) {
      if (typeof object.destroyCardNotification !== 'object') throw TypeError('.GamePacket.destroyCardNotification: object expected');
    ...
    if (object.gameEndNotification != null) {
      if (typeof object.gameEndNotification !== 'object') throw TypeError('.GamePacket.gameEndNotification: object expected');
